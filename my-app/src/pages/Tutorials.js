...
const Tutotrials = () => {
  ...
  <div className="tutorial-header">
    Here is the full list of (almost) all common calisthenics skills. This list
    will split the skills into their respective categories and list them in
    order from easiest to hardest. Progressions and difficulty level can be
    found on the skill’s page or by looking at the skill tree.
  </div>
  {/*simple header for page */}
  <div className="divider-line" />
  <br />
  <div className="skill-list-container">
    <div className="skill-list-header">horizontal push</div>
    <div className="skill-list-header">vertical push</div>
    <div className="skill-list-header">horizontal pull</div>
    <div className="skill-list-header">vertical pull</div>
    <div className="skill-list-header">legs</div>
  </div>
  {/*each group of skill list container is a row*/}
  {/*this can be duplicated so its scaleable, just change name and link*/}
  <div className="skill-list-container">
    <a className="skill-list-item" href="#">
      <button id="skill-item">Push-up</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Pike Push-up</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Inverted Row</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Pull-up</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Squat</button>
    </a>
  </div>
  <div className="skill-list-container">
    <a className="skill-list-item" href="planchelean.html">
      <button id="skill-item">Planche Lean</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Crow Pose</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">OA Inverted Row</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Chest Pull-up</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Assisted Pistol Squat</button>
    </a>
  </div>
  <div className="skill-list-container">
    <a className="skill-list-item" href="#">
      <button id="skill-item">Pseudo Planche Push-up</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Wall HS</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">TBD</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Waist Pull-up</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Pistol Squat</button>
    </a>
  </div>
  <div className="skill-list-container">
    <a className="skill-list-item" href="#">
      <button id="skill-item">Tuck PL</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Elevated Pike Push-up</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Tuck FL Row</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Tuck FL</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Dragon Pistol Squat</button>
    </a>
  </div>
  <div className="skill-list-container">
    <a className="skill-list-item" href="#">
      <button id="skill-item">Advanced Tuck Planche</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Freestanding HS</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Advanced Tuck FL Row</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Advanced Tuck FL</button>
    </a>
    <a className="skill-list-item" href="#">
      <button id="skill-item">Nordic Curl</button>
    </a>
  </div>
</>
