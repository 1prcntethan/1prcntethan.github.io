    ...
    return (
        <>
            ...
            <div className="svg-gradient-container">
                <svg className="svg-gradient" viewBox="0 0 2415 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="2415" height="80" rx="40" transform="matrix(1 0 0 -1 0 80)" fill="url(#paint0_linear_39_2)"/>
                    <defs>
