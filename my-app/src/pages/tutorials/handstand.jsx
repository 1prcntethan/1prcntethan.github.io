...
export function Handstand() {
    return (
        <>
            ...
            link1="/tutorials/pikepu" link2="/tutorials/assistedhs" link3="/tutorials/handstand" link4="/tutorials/bas" link5="#"
            svg1="pike-pu" svg2="assisted-hs" svg3="handstand" svg4="bas" svg5="hspu"/>
            <TutorialReturn />
            {svgDivider.get("2")}
