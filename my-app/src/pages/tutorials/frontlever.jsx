...
export function FrontLever() {
    return (
        <>
                ...
                <div className="skill-info">
                    ...
                    <div className="difficulty-muscle">
                        ...
                        <div className="overview-explanation">
                            The Front Lever is the trademark pull skill of calisthenics. The lats/back is the main muscle used in this exercise. Scapula retraction should be kept in mind in order to achieve a neutral scapula position.
                        </div>
                    </div>
                        ...
                        <div className="exercise-instructions">
                            ...
                            <div className="skill-instructions">
                                ...
                                <ul>
                                    ...
                                    <li>Unfold your hips, flatten your back, and fully extend your legs, with your entire body parallel to the ground. </li> 
                                    <li>Your body should be flat and your legs should be straight. </li> 
                    ...
                    <div className="recommended-info">
                        <p>
                            Recommended Main Exercises: Half Lay FL, Straddle FL, Straddle FL Rows, Pull-up
            ...
            {svgDivider.get("1")}
            <ProgressionChart name1="Inverted Row" name2="Half Lay FL" name3="Full Front Lever" name4="Full FL Row" name5="FL Touch"  
            link1="/tutorials/invertedrow" link2="/tutorials/halflayfl" link3="/tutorials/fullfl" link4="#" link5="#"
            svg1="inverted-row" svg2="half-lay-fl" svg3="full-fl" svg4="" svg5=""/>
            <TutorialReturn />
            {svgDivider.get("2")}
