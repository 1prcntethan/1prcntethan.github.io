...
export function TuckFL() {
    return (
        <>
            ...
            link1="/tutorials/invertedrow" link2="/tutorials/planchelean" link3="/tutorials/tuckfl" link4="/tutorials/pikefl" link5="#"
            svg1="inverted-row" svg2="" svg3="tuck-fl" svg4="pike-fl" svg5=""/>
            <TutorialReturn />
            {svgDivider.get("2")}
