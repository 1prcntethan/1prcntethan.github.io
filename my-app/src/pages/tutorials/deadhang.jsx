                ...
                <div className="skill-info">
                    ...
                    <div className="difficulty-muscle">
                        ...
                        <div className="overview-explanation">
                            The Deadhang is a base hanging exercise used to build grip strength and condition the body for vertical pulling movements. It doesn't actively grow muscles. However, it only builds endurance and stamina and gives a base level of hanging strength.
                        </div>
                    </div>
                    ...
                    <div className="recommended-info">
                        <p>
                            Recommended Main Exercises: Inverted Row
