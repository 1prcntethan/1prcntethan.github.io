...
export function PikeFLRow() {
    return (
        <>
                ...
                <div className="skill-info">
                    ...
                    <div className="difficulty-muscle">
                        ...
                        <div className="overview-explanation">
                            The Pike Front Lever Row is a regression exercise used to prepare the body more difficult front lever row progressions. The lats/back is the main muscle used in this exercise, as well as the mid-back. Scapula retraction should be kept in mind in order to achieve a neutral scapula position.
                        </div>
                    </div>
            ...
            {svgDivider.get("1")}
            <ProgressionChart name1="Inverted Row" name2="Pike Front Lever" name3="Pike FL Row" name4="Adv. Tuck FL" name5="Full Front Lever"  
            link1="/tutorials/invertedrow" link2="/tutorials/pikefl" link3="/tutorials/pikeflrow" link4="/tutorials/advtuckfl" link5="#"
            svg1="inverted-row" svg2="pike-fl" svg3="pike-fl-row" svg4="adv-tuck-fl" svg5=""/>
            <TutorialReturn />
            {svgDivider.get("2")}
