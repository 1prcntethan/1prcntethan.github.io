  ...
  return (
    <div className="leaf-drop-visual">
     ...
     C213,225 181,277 111,270 Z"
        ...
        {/* droplet — forms on the blade, rolls to the tip, falls */}
        ...
        <ellipse cx="151" cy="428" rx="14" ry="1" className="ripple ripple-1" />
        <ellipse cx="151" cy="428" rx="56" ry="4" className="ripple ripple-2" />
        <ellipse
          cx="151"
          cy="428"
          rx="112"
